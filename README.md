...
**A tiny(`1.8kb` :boom:) event store implementation with pure javascript. The library has no dependencies(`Zero Dependencies`). It works for Javascript's any hoist envirenment(browser, backend, desktop).**
